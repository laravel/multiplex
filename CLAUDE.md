...
- `cli.tsx` — CLI entry point. Parses args, sets up alternate screen, renders `<App>`. All exits funnel through a single `shutdown()`, wired to normal exit, render failure, and SIGINT/SIGTERM/SIGHUP/SIGQUIT.
